...
{
      if(mysqli_query($link,"update data_card set status='$status', opTxid='$txid', errorCode='$error_code' , resText='$resText' where id='$id'"))
      {
...
/*--------------------------------------------------------------------------------*/
                    ...
                    {
	               $statuse="REFUND";
	               mysqli_query($link,"update data_card set status='$statuse' where username='$username'");                     
                    }
   } 
 } 
 } 
