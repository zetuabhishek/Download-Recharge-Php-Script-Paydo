...
{
      if(mysqli_query($link,"update dth set status='$status', opTxid='$txid', errorCode='$error_code' , resText='$resText' where id='$id'"))
      {
...
/*--------------------------------------------------------------------------------*/
                    ...
                    {
	               $statuse="REFUND";
	               mysqli_query($link,"update dth set status='$statuse' where username='$username'");                     
                    }
   } 
 } 
 } 
