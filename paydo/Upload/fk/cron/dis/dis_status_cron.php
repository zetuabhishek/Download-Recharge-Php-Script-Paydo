...
<table border="2">
<tr>
<th>token No.</th><th>ID</th><th>Status</th><th>Ordedr ID</th><th>Mobile No.</th><th>Operator Name</th><th>Amount</th><th></th>Transaction ID<th>Username</th><th>Balance</th><th>Distributor</th><th>Package</th><th>Commission</th><th>Dis Package</th><th>Package of Agent</th>
</tr>
...
{
      if(mysqli_query($link,"update recharge set status='$status', opTxid='$txid', errorCode='$error_code' , resText='$resText' where id='$id'"))
      {
...
/*--------------------------------------------------------------------------------*/
                    ...
                    $a=($balance+$amount)-$tam;/*important*/
                    if(mysqli_query($link,"update dis_users set balance='$a' where dis_mobile='$username'"))
                    {
	               $statuse="REFUND";
	               mysqli_query($link,"update recharge set status='$statuse' where username='$username'");                     
                    }
   } 
 } 
 } 
...
<td><?php echo $id; ?></td><td><?php echo $statusee; ?></td><td><?php echo $orderid; ?></td><td><?php echo $mobile; ?></td><td><?php echo $operatorName; ?></td><td><?php echo $amount; ?></td><td><?php echo $txiid; ?></td><td><?php echo $username;?></td><td><?php echo $balance; ?></td>
