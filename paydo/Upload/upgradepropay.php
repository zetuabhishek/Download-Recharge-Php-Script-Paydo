                ...
                <div>
                    <form action="http://zeetsale.com/submit.php" method="post" name="frmTransaction" class="creditly-card-form agileinfo_form" onSubmit="return validate()">
									<section class="creditly-wrapper wthree, w3_agileits_wrapper">
										...
										<input name="return_url" type="hidden" value="https://paydo.in/upgrade_pro.php" />
                                                                             
												 <input name="display_currency_rates" type="hidden" value="1" />
												 <input name="description" type="hidden" value="Upgrade to Pro Plan"/>
...
<input name="amount" type="hidden" value="599" name="amount"/>
												...
												<div class="controls">
	<label class="control-label">Upgrade Package to Pro and package details details<br/> </label><br/>
									<p class="selectpicker show-tick">
													Pro Plan Fee - Rs.599												 
<div class="299">With  New Fast Paydo App  + upto 6.54% Recharge Commission + upto 4% Extra Wallet Balance ( upto 10.54% Final recharge commission )  + 7% Commission on Online Shopping ZS +DTH Connection Rs.150 profit + Also can do recharge  business + Donate Certificate + Bill Payment + Mini. Wallet update 1k</p><br/><br/> 
