	...
	<div class="w3l-footer-bottom">
		<div class="container-fluid">
			<div class="col-md-4 w3-footer-logo">
				...
				<h2><a href="index.html"><?php echo $website; ?></a></h2>
			</div>
...
<!-- for bootstrap working -->
		<script src="https://<?php echo $domain; ?>/theme/js/bootstrap.js"></script>
<!-- //for bootstrap working --><!-- Responsive-slider -->
    <!-- Banner-slider -->
<script src="https://<?php echo $domain; ?>/theme/js/responsiveslides.min.js"></script>
   <script>
    $(function () {
...
<script src="https://<?php echo $domain; ?>/theme/js/bootstrap-select.js"></script>
<script>
